...
// config/index.js
import dotenv from 'dotenv';
dotenv.config(); // Ensure this is at the very top to load .env variables immediately

// --- Database Config ---
const databaseConfig = {
    // This now reads process.env AFTER dotenv.config() has run
...
// --- Main Export ---
// This object now combines all configurations, ensuring they are created with loaded env variables.
export default {
    database: databaseConfig,
    auth: authConfig,
    port: process.env.PORT || 5000,
